...
p = figure(plot_height=350, title="Rating Distributing of Seller 1", toolbar_location=None,
...
p_gen = figure(plot_height=350, title="Gender Distribution of Customers of Seller 7", toolbar_location=None,
           tools="hover", tooltips=[("Country", "@country"),("Value", "@value")])
...
p_addr = figure(plot_height=350, title="Location Distribution of Customers of Seller 7", toolbar_location=None,
           tools="hover", tooltips=[("Country", "@country"),("Value", "@value")])
...
page3 = wd.Panel(child = sta2, title = "Rating Distribution (Gender)")
